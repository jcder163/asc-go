...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/jcder163/asc-go/asc)](https://pkg.go.dev/github.com/jcder163/asc-go/asc)
[![Test Status](https://github.com/jcder163/asc-go/workflows/Run%20Tests/badge.svg)](https://github.com/jcder163/asc-go/actions?query=workflow%253A%2522Run+Tests%2522)
...
```go
import "github.com/jcder163/asc-go/asc"
```
...
For more sample code snippets, head over to the [examples](https://github.com/jcder163/asc-go/tree/main/examples) directory.
...
For complete usage of asc-go, see the full [package docs](https://pkg.go.dev/github.com/jcder163/asc-go/asc).
